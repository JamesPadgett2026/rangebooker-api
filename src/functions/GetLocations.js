...
app.http("GetBulletinBoardPosts", {
    ...
    authLevel: "anonymous",
    handler: async (request, context) => {
        context.log("GetBulletinBoardPosts called");
        ...
        try {
            ...
            const posts = items
                ...
                .sort((a, b) => {
                    const da = new Date(a.datePostInformation || a.dateAdded || 0);
                    const db = new Date(b.datePostInformation || b.dateAdded || 0);
                    return db - da;
                });
            ...
            context.log("GetBulletinBoardPosts error:", err);

            return {
                status: 500,
                jsonBody: {
                    success: false,
                    error: err.message || "Unable to load bulletin board posts."
                }
            };
        }
    }
